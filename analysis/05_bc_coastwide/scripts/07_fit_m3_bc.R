# ============================================================================
# 07_fit_m3_bc.R — Fit hierarchical M3 BC-wide (adds Gompertz density-dep)
# analysis/05_bc_coastwide
#
# Same structure as scripts/06_fit_m1_bc.R; only the Stan model path and
# output filename differ. SUBSET env var works identically.
# ============================================================================
