// ============================================================================
// herring_metapop_m1_v3.stan — M1v3: Improved Baseline (Okamoto-inspired)
//
// IMPROVEMENTS from v2:
//   1. Tight dive-method prior used in the Okamoto empirical model: Normal(0, 0.05)
//   2. Site-specific observation error hierarchical: sigma_obs[j]
//   3. Diagonal-Equal Process Error (sigma_proc)
// ============================================================================
