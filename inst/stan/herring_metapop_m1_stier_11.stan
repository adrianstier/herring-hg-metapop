// ============================================================================
// herring_metapop_m1_stier_11.stan
//
// Stier-aligned 11-section baseline:
//   1. Density-independent biomass process with PDO and fishing.
...
//   4. No predator, density-dependence, size, or age structure.
//
// This is not a literal JAGS translation. It preserves the core Stier data
// interpretation while using sampler-stable Stan parameterization.
// ============================================================================
...
model {
  ...
  // Centered near the legacy posterior scale but broad enough for the current
  // DFO tonnes-scale spawn index.
