...
models <- tribble(
  ...
  "m5_stier_doherty_mp_covariate",  file.path(proc_dir, "m5_stier_doherty_mp_covariate_fit.rds"),  file.path(proj_dir, "inst/stan/herring_metapop_m5_stier_doherty_mp_covariate.stan"), file.path(proj_dir, "Code/03_fit_m5_stier_doherty_mp_covariate.R"),
