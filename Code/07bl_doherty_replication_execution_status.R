...
execution_status <- tribble(
  ...
  paste0(
    ...
    ", HG SCA-output recruitment rows=", newer_rows$sr_2025_hg_recruitment,
  ...
  "Public summaries confirm data streams through 2024, but Table 11 recruitment is SCA model output; they do not provide exact annual age/weight matrices, effective sample sizes, or fish-level length-at-age.",
  ...
  "Public HG catch, spawn, number-at-age, weight-at-age, biosamples, maturity, and recent SCA summary/output tables are now in provisional CSV form.",
...
lines <- c(
  ...
  "- Newer public PDFs now add DFO 2025/005 HG summary tables through 2024 for catch, spawn, SCA parameters, SCA model-output recruitment, biomass/depletion, reference points, and broad projected age proportions.",
