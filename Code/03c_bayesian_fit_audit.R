...
models <- tribble(
  ...
  "m5_combined",  file.path(proc_dir, "m5_combined_fit.rds"),  file.path(post_dir, "loo_m5_combined.rds"),  file.path(proj_dir, "inst/stan/herring_metapop_m5_combined.stan"), file.path(proj_dir, "Code/03_fit_m5_combined.R"), 15L,
