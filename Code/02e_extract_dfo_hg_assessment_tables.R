...
summary_lines <- c(
  ...
  "## Source Fields",
  "",
  "Clean extracts retain `source_document`, `source_table`, `source_url`, `extraction_method`, and `extraction_notes`. The tracked source map is `docs/doherty-style-hg-source-provenance.md`.",
  "",
  "## Extracted Products",
  "",
