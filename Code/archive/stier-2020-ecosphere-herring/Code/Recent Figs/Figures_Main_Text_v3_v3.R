...
load("diagonal_equal_design_c_DDspatial_noUsig_eta.Rdata") #MCMC output
...
md$altsite<-substr(colnames(Y),5,28)
 ...
 pdf(paste("DistanceDecay_eta",Sys.Date(),".pdf"), width=12,onefile = TRUE)
...
ggplot(pc_tab2,aes(x=section,y=pc))+
