...
save("model","mDIC","inits","design.c",
     file="diagonal_equal_design_c_DDspatial_noUsig.Rdata")
...
pdf(paste("diagonal_equal_design_c_DDspatial_noUsig",Sys.Date(),".pdf"), onefile = TRUE)
...
nm<-c("q","tauR2","pdocoef","Umu","theta","sigma2")
