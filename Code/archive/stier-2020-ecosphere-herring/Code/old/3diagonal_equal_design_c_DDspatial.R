...
for(i in 2:nYears){
 ...
 ",file="diagonal_equal_design_c_DDspatial.txt")
...
model.loc="diagonal_equal_design_c_DDspatial.txt" # name of the txt file
...
load("diagonal_equal_design_c_DDspatial.Rdata")
...
pdf(paste("diagonal_equal_design_c_DDspatial",Sys.Date(),".pdf"), onefile = TRUE)
...
slist<-list(qdf,tauRdf,pdodf,Umudf,Usigdf,thetadf,sigma2df)
nm<-c("q","tauR2","pdocoef","Umu","Usig2","theta","sigma2")
