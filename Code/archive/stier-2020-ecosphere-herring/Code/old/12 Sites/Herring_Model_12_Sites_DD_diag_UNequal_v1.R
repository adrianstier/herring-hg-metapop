...
X[i,j] <-Z[i,j]+log(1-Pc[i,j]);
 ...
 ",file="normal_spatialRW_12sites.txt")
...
model.loc="normal_spatialRW_12sites.txt" # name of the txt file
...
save("model","mDIC","X","theta","sigma2","U","Umu","Usig","Z","delta","Q","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_12sites_DD_unequal_var.RData")

load("herring_jags_F_12sites_DD_unequal_var.RData")
########################################################################
...
pdf(paste("12sites_DD_Diagonal_UN_Equal_Chains_Posteriors",Sys.Date(),".pdf"), onefile = TRUE)
