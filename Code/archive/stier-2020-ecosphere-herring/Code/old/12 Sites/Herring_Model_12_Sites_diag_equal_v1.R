...
X[i,j] <-Z[i,j]+log(1-Pc[i,j]);
 ...
 ",file="normal_spatialRW_12sites_DiagEqual.txt")
...
model.loc="normal_spatialRW_12sites_DiagEqual.txt" # name of the txt file
...
save("model","mDIC","X","sigma2","U","Umu","Usig","Z","delta","sigma2","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_12sites_diag_equal_var.RData")

load("herring_jags_F_12sites_diag_equal_var.RData")
########################################################################
...
pdf(paste("Chains and Posteriors_12sites_DiagEqual",Sys.Date(),".pdf"), onefile = TRUE)
