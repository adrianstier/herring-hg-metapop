...
save("model","mDIC","X","theta","sigma2","U","Umu","Usig","Z","delta","Q","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_12sites_equal_var.RData")

load("herring_jags_F_12sites_equal_var.RData")
...
pdf(paste("Chains and Posteriors_thetarunif",Sys.Date(),".pdf"), onefile = TRUE)
