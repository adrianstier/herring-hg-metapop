...
ctab2_1_car<-ctab2_1[,c(9,10,11,8,12,5,1,4,3,2,7,6)] #car model
...
for(i in 2:nYears) {
 ...
 ",file="normal_spatialRW_12sites_CAR_identity.txt")
...
model.loc="normal_spatialRW_12sites_CAR_identity.txt" # name of the txt file
...
save("model","mDIC","X","U","Umu","Usig","Z","delta","Q","pdo","pdocoef","Pc","q","tauR","tau2Inv",file="herring_jags_F_12sites_equal_var_CAR.RData")

#load("herring_jags_F_12sites_equal_var_CAR.RData")
########################################################################
...
pdf(paste("12sites_CAR_equalvar_Chains_Posteriors",Sys.Date(),".pdf"), onefile = TRUE)
