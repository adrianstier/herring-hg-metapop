...
for(i in 2:nYears) {
 ...
 ",file="normal_spatialRW_11sites_CAR_unequalvar_2015_no_psi_noTauR.txt")
...
model.loc="normal_spatialRW_11sites_CAR_unequalvar_2015_no_psi_noTauR.txt" # name of the txt file
...
save("model","mDIC","X","U","Umu","Usig","Z","delta","Qinv","phi","pdo","pdocoef","Pc","q","tau2",file="herring_jags_F_11sites_UNequal_var_CAR_2015_v6_psi_noPsi_noTauR.RData")

load("herring_jags_F_11sites_UNequal_var_CAR_2015_v6_psi_noPsi_noTauR.RData")
...
#   
  ...
  slist<-list(qdf,pdodf,Umudf,Usigdf,phidf)
  nm<-c("q","pdocoef","Umu","Usig","phi")
  i=2
