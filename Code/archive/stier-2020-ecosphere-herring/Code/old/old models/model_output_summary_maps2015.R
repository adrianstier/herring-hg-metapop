...
data.frame(colnames(Y2),colnames(ctab2))

colnames(ctab2)<-colnames(Y2)
...
##############################################################################################################################
data.frame(colnames(Y_car),colnames(ctab2_1)) #name check

ndf<-data.frame(melt(Y_car),melt(ctab2_1))[,c(3:6)]
...
cf<-melt(data.frame(ctab2_1_car,"year"=years),id.vars=c("year"))
