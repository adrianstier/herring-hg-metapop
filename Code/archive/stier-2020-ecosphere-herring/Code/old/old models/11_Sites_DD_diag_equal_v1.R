...
X[i,j] <-Z[i,j]+log(1-Pc[i,j]);
 ...
 ",file="normal_DD_Diag_Equal_11sites.txt")
...
model.loc="normal_DD_Diag_Equal_11sites.txt" # name of the txt file
...
save("model","mDIC","X","theta","sigma2","U","Umu","Usig","Z","delta","Q","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_11sites_DD_equal_var.RData")


load("herring_jags_F_11sites_DD_equal_var.RData")
...
pdf(paste("11sites_DD_Diagonal_Equal_Chains_Posteriors",Sys.Date(),".pdf"), onefile = TRUE)
