...
save("model","mDIC","X","U","Umu","Usig","Z","delta","Qinv","phi","pdo","pdocoef","Pc","tl","q","tauR","tau2",file="herring_jags_F_11sites_UNequal_var_CAR.RData")
...
pdf(paste("11sites_CAR_UNequalvar_Chains_Posteriors",Sys.Date(),".pdf"), width=17,onefile = TRUE)
...
mms<-scale(Y_car)
mms<-data.frame("year"=seq(1950,2013,1),mms)
...
dfa<-data.frame("year"=seq(1950,2013,1),"cumspawn"=scale(rowSums(Y_car,na.rm=T)))
