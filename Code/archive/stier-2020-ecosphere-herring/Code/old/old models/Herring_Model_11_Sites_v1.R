...
#subset out Cartwright Sound (4)-no catch data, Masset (11), Skitigate (22), and Naden Harbor (12)
...
ggsave(paste("CCF_9_Sites_FishSwims",Sys.Date(),".pdf"))
...
save("model","mDIC","X","theta","sigma2","U","Umu","Usig","Z","delta","Q","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_9sites.RData")
