...
tauR ~ dunif(0,1000); #this is the estimated variance prior for Spawn Index
...
psi ~ dunif(0,1000) #this is in variance for fishing set fixed to try to get convergence
...
for(i in 2:nYears) {
 ...
 ",file="normal_spatialRW_11sites_CAR_equalvar_2015_fixedpsi_freeTauR.txt")
...
model.loc="normal_spatialRW_11sites_CAR_equalvar_2015_fixedpsi_freeTauR.txt" # name of the txt file
...
save("model","mDIC","X","U","Umu","Usig","Z","delta","Qinv","phi","pdo","pdocoef","Pc","q","tau2","tauR",file="herring_jags_F_11sites_equal_var_CAR_2015_fixedPsi_freeTauR.RData")

load("herring_jags_F_11sites_equal_var_CAR_2015_fixedPsi_freeTauR.RData")
...
#head(model$BUGSoutput$sims.array)
  ...
  pdf(paste("11sites_CAR_UNequalvar_Chains_Posteriors_1950_2015_psi_dunif_free_tauR",Sys.Date(),".pdf"), width=8.5,height=11,onefile = TRUE)
...
#   
  ...
  slist<-list(qdf,pdodf,Umudf,Usigdf,phidf,tau2df,tauRdf)
  nm<-c("q","pdocoef","Umu","Usig","phi","tau2","tauR")
  i=2
