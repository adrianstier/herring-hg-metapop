...
for(i in 2:nYears){
 ...
 ",file="diagonal_equal_design_c_autocor_delta_noUsig.txt")
...
jags.params=c("X","sigma2","Umu","delta","Z","pdocoef","log.q","Pc","tauR2","rho")


model.loc="diagonal_equal_design_c_autocor_delta_noUsig.txt" # name of the txt file
...
## ==================
# ##save("model","mDIC","inits","sigma2","U","Umu","Usig2","Z","delta","sigma2"#,#"pdo","pdocoef","Pc","log.q","tauR2",
#      "design.c","rho",
#      file="diag_equal_design_c_autocor_delta.RData")

setwd("~/Dropbox/Projects/In Progress/Herring_Haida_Gwaii/Code")

save("model","mDIC","inits",
     file="diag_equal_design_c_autocor_delta_noUsig_tauR1.RData")

setwd("~/Dropbox/Projects/In Progress/Herring_Haida_Gwaii/Code")

load("diag_equal_design_c_autocor_delta_noUsig.RData")
...
pdf(paste("diagonal_equal_design_c_autocor_delta_noUsig",Sys.Date(),".pdf"), onefile = TRUE)
...
slist<-list(qdf,pdodf,Umudf,sigma2df,rhodf)
nm<-c("log.q","pdocoef","Umu","sigma2","rho")
