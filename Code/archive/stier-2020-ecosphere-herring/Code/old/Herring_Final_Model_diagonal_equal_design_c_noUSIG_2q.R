...
for(i in 2:nYears){
 ...
 ",file="diag_equal_design_c_noUsig_2q.RData.txt")
...
model.loc="diag_equal_design_c_noUsig_2q.RData.txt" # name of the txt file
...
save("model","mDIC","inits",
     file="diag_equal_design_c_noUsig_2q.RData")
...
write.csv(MCMCsummary(model),"AllParams.csv")
...
MCMCtrace(model,params='Pc',filename="X_chains_posteriors.pdf")



## ==================
## Use MCMCvis package to pull out table of posteriors and 
## ==================
...
pdf(paste("diagonal_equal_design_c_noUsig_2q",Sys.Date(),".pdf"), onefile = TRUE)
