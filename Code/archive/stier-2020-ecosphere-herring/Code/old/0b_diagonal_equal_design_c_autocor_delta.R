...
save("model","mDIC","inits",
     file="diag_equal_design_c_autocor_delta_noUsig_hardprior_tau_sigma2_umu.RData")
...
pdf(paste("diagonal_equal_design_c_autocor_delta_noUsig_priorUmu",Sys.Date(),".pdf"), onefile = TRUE)
