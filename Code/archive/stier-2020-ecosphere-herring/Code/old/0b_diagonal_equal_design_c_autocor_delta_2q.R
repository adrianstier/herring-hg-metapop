...
for(i in 2:nYears){
 ...
 ",file="diagonal_equal_design_c_autocor_delta_noUsig_2q.txt")
...
model.loc="diagonal_equal_design_c_autocor_delta_noUsig_2q.txt" # name of the txt file
...
save("model","mDIC","inits",
     file="diag_equal_design_c_autocor_delta_noUsig_hardprior_tau_sigma2_umu_2q.RData")

setwd("~/Dropbox/Projects/In Progress/Herring_Haida_Gwaii/Code")

load("diag_equal_design_c_autocor_delta_noUsig_hardprior_tau_sigma2_umu_2q.RData")
...
pdf(paste("diagonal_equal_design_c_autocor_delta_noUsig_priorUmu_2q",Sys.Date(),".pdf"), onefile = TRUE)
