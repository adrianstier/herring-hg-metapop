...
ggplot(ccf_df,aes(x=distance,y=cor))+
  ...
  #geom_smooth()+
  theme_acs()+
  xlab("Distance Between Sites (as fish Swims")+
...
#########
#CCF for all sites relative to PDO
#########
...
model.loc="normal_spatialRW_9sites_no spatial cov.txt" # name of the txt file
...
save("model","X","theta","sigma2","U","Umu","Usig","delta","Q","pdo","pdocoef","Pc","q","tauR",file="herring_jags_F_9sites_thetarunif.RData")
